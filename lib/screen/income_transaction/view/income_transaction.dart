...
class Income_tra extends StatefulWidget {
  const Income_tra({Key? key}) : super(key: key);

  @override
  _Income_traState createState() => _Income_traState();
}

class _Income_traState extends State<Income_tra> {
